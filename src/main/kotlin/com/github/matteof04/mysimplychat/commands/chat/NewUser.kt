...
object NewUser : Command {
    override fun getCommandString(): String = "newuser"
    override fun getCommandByte(): Byte = 0x06.toByte()
    override fun encode(payload: List<String>): ByteArray = "${payload[0]}~${payload[1]}".encodeToByteArray()
}